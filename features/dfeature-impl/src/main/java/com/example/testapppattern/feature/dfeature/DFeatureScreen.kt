...
@Composable
internal fun DFeatureScreen(
    graphHolder: DFeatureGraphHolderViewModel,
) {
    val navigator = LocalAppNavigator.current
    val vmFactory = remember(graphHolder) {
        FunctionViewModelFactory { graphHolder.component.dFeatureViewModel() }
    }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.d_feature_title)) },
                navigationIcon = {
                    TextButton(onClick = { navigator.back() }) {
                        Text(stringResource(R.string.d_feature_back))
                    }
                },
            )
        },
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.d_feature_subtitle),
